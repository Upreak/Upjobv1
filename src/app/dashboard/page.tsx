                ...
                <CardContent>
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center space-x-4">
                      <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
                      <div className="flex-1">
                        <p className="text-sm font-medium">Candidate profile updated</p>
          ...
          <div className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-2xl font-bold">0</div>
                  <p className="text-xs text-muted-foreground">No saved jobs</p>
                </CardContent>
              </Card>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <Card>
                ...
                <CardContent>
                  <div className="space-y-4">
                    <div className="flex items-center justify-between p-4 border rounded-lg">
                      <div>
                        <p className="font-medium">Sample Developer Position</p>
                        <p className="text-sm text-muted-foreground">Tech Company • Remote</p>
                      </div>
                      <Badge className="bg-blue-100 text-blue-800">95% Match</Badge>
                    </div>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardHeader>
                  <CardTitle>Quick Actions</CardTitle>
                  <CardDescription>Common job seeker tasks</CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="grid grid-cols-2 gap-4">
                    <Link href="/jobs">
                    ...
                    <Link href="/dashboard/candidate/saved">
                      <Button variant="outline" className="w-full">
                        <Bell className="h-4 w-4 mr-2" />
                        Saved Jobs
                      </Button>
